...
variable "mgmt_container_port" {
  description = "The port number on which the containers are listening for mgmt"
  type        = number
}
...
variable "mgmt_health_code" {
  description = "The HTTP codes to use when checking for a successful response from a target for mgmt lb"
  type        = string
}
...
variable "mgmt_health_path" {
  description = "The destination path for the health check request for mgmt lb"
  type        = string
}
...
variable "host_header" {
  type        = string
  description = "the host header for the listener for oxolo doc"
}

variable "redirect_host" {
  type        = string
  description = "the host to redirect to for oxolo doc"
}

variable "healthy_threshold" {
  type        = number
  description = "The number of consecutive successful health checks required to mark a target as healthy for main LB"
}

variable "interval" {
  type        = number
  description = "The approximate amount of time, in seconds, between health checks for main LB"
}

variable "timeout" {
  type        = number
  description = "The amount of time, in seconds, during which no response means a failed health check for main LB"
}
